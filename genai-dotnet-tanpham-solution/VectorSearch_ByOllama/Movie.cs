...
namespace VectorSearch_ByOllama
{
    public class Movie
    {
        [VectorStoreKey]
        ...
        // [VectorStoreVector] đánh dấu đây là trường lưu trữ chuỗi Vector toán học (Embedding).
        // - Dimensions: 384 -> Chỉ định vector này có 384 chiều (kích thước chuẩn của nhiều mô hình embedding như all-MiniLM-L6-v2).
        // - DistanceFunction: CosineSimilarity -> Chỉ định thuật toán tìm kiếm khoảng cách là Cosine (đo góc giữa 2 vector để xác định mức độ giống nhau về ngữ nghĩa).
        [VectorStoreVector(
            Dimensions: 384,
